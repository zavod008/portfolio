export default [
    {
        id: 21,
        title: 'AmigoHostels',
        description: '<p>Мой первый проект на vue. Разрабатывался около года.</p>\n' +
      '<p>Основная проблема была в ssr, а точнее в его отсутствии, проблему решили дублированием контента через php, не комильфо, но работает.</p>\n' +
      '<p>Бэк работает на yii2.</p>\n' +
      '<p>Запилены две отдельные версии под десктоп и мобилу.</p>\n' +
    ...
    {
        id: 13,
        title: 'Аэродром Новинки',
        description: '<p>В данном проекте, полностью выполнил верстку всего и вся.&nbsp;</p>\n' +
    ...
    },
    {
        id: 14,
        title: 'Сушивёсла',
        description: '<p>За время моей недолгой работы над этим проектом, успел сделать пару страниц, и поиграться с версткой на странице доставки.</p>\n' +
          '<p><a target="_blank" href="https://xn--80adjkr6adm9b.xn--p1ai/about/active">https://xn--80adjkr6adm9b.xn--p1ai/about/active</a></p>\n' +
    ...
    },
    {
        id: 22,
        title: 'Alfascaner',
        description: '<p>Пришлось конкретно поднатужиться, чтобы из этого сайта сделать что-то более менее адекватное. Пришел проект ко мне как обычно с громадным количеством css и js файлов, разной степени тяжести.</p>\n' +
          '<p>Я так понимаю сайт изначально делался на какой-то теме, и ее просто подпилили под себя, а весь ненужный код, мало того что загружается каждый раз, так его еще и довольно много.</p>\n' +
          '<p>Чего стоит один slider Revolution (кто знает, тот поймет что это за писец). До сих пор теряюсь в догадках, где предыдущий прогер смог его достать, а тем более какую-то супер древнюю версию.</p>\n' +
          '<p>Так что, когда заказчик начал жаловаться что все медленно грузиться (неожиданно), было приянто стратегическое решение решение, перевести фронт на вебпак, а точнее laravel-mix, благо его легко прикручивать к любому проекту, ну и плюс мелкие оптимизации вроде webp, замены плагинов (зачем мне 2 слайдера в проекте, если может быть 1).</p>\n' +
          '<p>В конечном счете поднял гугл спид с 20 до 85, ну и скорость заметно возросла, что не может не радовать.</p>\n' +
    ...
    },
    {
        id: 25,
        title: 'Web-Crazy',
        description: '<p>Классическая разработка сайта для компаний в которой работаешь.</p>\n' +
          '<p>Долго думали дизайнить или брать тему, в итоге пришли к выводу, что тема будет быстрей и дизанера напрягать не нужно.</p>\n' +
          '<p>Классический корпоративный сайт, ничего примечательного, разве что калькулятор был сделан на vue (вписался идеально).</p>\n' +
    ...
    },
    {
        id: 8,
        title: 'Дентал Арт',
        description: '<p>Классический корпоративный сайт, ничего примечательного.</p>\n' +
    ...
    },
    {
        id: 26,
        title: 'Олимп Бизнес',
        description: '<p>В данном проекте выполнил верстку всего личного кабинета, а позже и фронтовой части, но вот смотрел недавно, никто ее пристраивать не торопиться.</p>\n' +
    ...
    },
    {
        id: 4,
        title: 'Ультратех',
        description: '<p>Сайт был на технической поддержке, задачей было сделать страницу политики&nbsp;конфиденциальности и сделать возможность скачивать документы без указания электронной почты.</p>\n' +
    ...
    },
    {
        id: 7,
        title: 'GreatDoor',
        description: '<p>С этим сайтом было много мелких правок, по типу, добавить lazy load, для картинок в слайдере, ибо если на странице 20 слайдеров, и каждый грузит сразу все изображения, то получается атас.</p>\n' +
    ...
    },
    {
        ...
        description: '<p>Полный редизайн главной страницы.</p>\n' +
    ...
    },
    {
        id: 23,
        title: 'Апартаменты',
        description: '<p>Сайт попал, а точнее верстка попала ко мне с задачей натяжки этого веселья на вп.&nbsp;</p>\n' +
    ...
    },
    {
        id: 3,
        title: 'СБА',
        description: '<p>Типичный интернет магазин.</p>\n' +
